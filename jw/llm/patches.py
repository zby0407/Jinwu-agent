...
def _patch_deepseek_reasoning_passback(model: Any) -> None:
    ...
    older jw version that ran before the capture patch landed), we
    ...
    jw/llm/models.py), so all callers are DeepSeek endpoints.
    ...
    def _patched(input_: Any, *, stop: Any = None, **kwargs: Any) -> dict:
        ...
        for msg in msgs:
            ...
            if rc:
                ...
                # DeepSeek Flash) or from an older jw that didn't capture
