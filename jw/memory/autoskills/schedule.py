"""LangGraph scheduling helpers for JWMemory AutoSkills."""
...
AUTOSKILL_GRAPH_ID = "jwmemory-autoskills"
AUTOSKILL_RUN_KIND = "jwmemory_autoskills"
...
def _autoskill_input() -> dict[str, Any]:
    return messages_input(
        "Run JWMemory AutoSkills maintenance. Inspect candidate "
