...
def _runtime_project_id(runtime: ToolRuntime | None, default_project_id: str) -> str:
    return _runtime_config_value(runtime, "jwmemory_project_id") or default_project_id
...
def _runtime_session_id(runtime: ToolRuntime | None) -> str | None:
    ...
    source_session_id = _runtime_config_value(runtime, "jwmemory_source_session_id")
...
def _resolve_observation_context(
    ...
    *,
    ...
    return _ObservationContext(
        ...
        source_agent=_runtime_config_value(runtime, "jwmemory_source_agent")
        or source_agent,
    )
...
def create_search_observations_tool(
    *,
    ...
    return StructuredTool.from_function(
        ...
        description=(
            "Search JWMemory observation summaries and bodies with ranked "
...
def create_read_memory_tool(
    *,
    ...
    return StructuredTool.from_function(
        ...
        name="read_memory",
        description=(
            "Read the full markdown for an JWMemory observation by exact "
...
def create_record_observation_tool(
    *,
    ...
    return StructuredTool.from_function(
        ...
        description=(
            "Record compact reusable memory as a structured JWMemory "
    ...
    *,
    ...
    return StructuredTool.from_function(
        ...
        description=(
            ...
            "two existing JWMemory observations. Use this only after reading "
