...
def _step_channels(config: JWConfig) -> dict[str, object]:
    ...
    # exact dependency without requiring the jw package itself
            ...
            try:
                ...
                if install_now:
                    ...
                    if _pip_pkgs:
                        ...
                        _ok = install_library(f"jw[{pip_extra}]")
                    if _ok:
                        ...
                        try:
                            ...
                            console.print(
                                "  [dim]Try restarting and running:[/dim] jw channel setup"
                            )
                    else:
