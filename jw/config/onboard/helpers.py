...
def _provider_key_info(config: JWConfig, provider: str):
...
def _prompt_ccproxy_port(config: JWConfig) -> None:
...
def _install_ccproxy() -> bool:
    """Run pip install for ccproxy (jw[oauth]).
