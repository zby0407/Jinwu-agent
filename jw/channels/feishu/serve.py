...
Usage:
    python -m jw.channels.feishu.serve --app-id ID --app-secret SECRET [OPTIONS]

Examples:
    # Basic setup
    python -m jw.channels.feishu.serve --app-id ID --app-secret SECRET
    ...
    python -m jw.channels.feishu.serve --app-id ID --app-secret SECRET --agent --thinking
"""
