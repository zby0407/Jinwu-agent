"""CodeInterpreterMiddleware configuration for JW.
...
Usage::
    ...
    from jw.middleware import create_code_interpreter_middleware
...
# builder in ``agent.py``) pass the resolved ``JWConfig``
...
class JWCodeInterpreterMiddleware(CodeInterpreterMiddleware):
    """Code interpreter middleware with JW's memory preflight hint."""
...
def create_code_interpreter_middleware(
    *,
    ...
    Returns:
        ...
        middleware stack.
    """
    return JWCodeInterpreterMiddleware(
