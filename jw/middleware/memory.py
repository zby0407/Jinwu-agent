...
PROFILE_TEMPLATES: dict[str, str] = {
    "/profile/SOUL.md": """# JW soul

Default behavior for this copy of JW.
...
Things worth remembering about the person using JW.
...
class JWMemoryMiddleware(AgentMiddleware):
    """Middleware that maintains the profile memory files used by JW.
