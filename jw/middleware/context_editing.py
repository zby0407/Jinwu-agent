"""ContextEditingMiddleware configuration for JW.
...
Usage::
    ...
    from jw.middleware import create_context_editing_middleware
...
def create_context_editing_middleware(model: BaseChatModel | None = None):
    """Build a ContextEditingMiddleware with JW defaults.
