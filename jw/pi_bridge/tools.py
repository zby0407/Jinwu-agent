"""Bridge pi tool calls into JW's sandbox backend."""
...
class PiToolBridge:
    """Execute pi-style file/shell tools through JW backends.
    ...
    Additionally exposes JW-native capabilities:
    ...
    @staticmethod
    def _build_backend(
        workspace_dir: str, config: JWConfig | None = None
    ) -> CompositeBackend:
        cfg = config
    ...
    def read_memory(self, observation_id: str) -> dict[str, Any]:
        """Read a single JWMemory observation by id."""
        try:
    ...
    def record_observation(
        ...
        *,
        ...
        """Record a structured JWMemory observation."""
        try:
            ...
            def __init__(self, session_id: str, project_id: str):
                self.config = {
                    "configurable": {
                        ...
                        "jwmemory_source_session_id": session_id,
                        "jwmemory_project_id": project_id,
                    }
                }
