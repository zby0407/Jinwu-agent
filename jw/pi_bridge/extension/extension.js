 ...
 * to the JW Python backend via a Unix domain socket.
 *
 * Additionally exposes JW capabilities: full filesystem tools
...
const SOCKET_PATH = process.env.agent_PI_TOOL_SOCKET;

function sendRequest(request) {
  return new Promise((resolve, reject) => {
    if (!SOCKET_PATH) {
      reject(new Error("JW_PI_TOOL_SOCKET is not set"));
      return;
    }
...
module.exports = function piBridgeExtension(api) {
  // -------------------------------------------------------------------------
  // Filesystem tools (routed to JW sandbox backend)
  // -------------------------------------------------------------------------
  ...
  registerBridgeTool(
    ...
    "Find files matching a glob pattern through the JW Python sandbox backend."
  );
  ...
  registerBridgeTool(
    ...
    "Search file contents through the JW Python sandbox backend."
  );

  // -------------------------------------------------------------------------
  // JW memory observation tools
  // -------------------------------------------------------------------------
  ...
  registerBridgeTool(
    ...
    "Read a full JW memory observation by ID."
  );
  ...
  registerBridgeTool(
    ...
    "Create a recurring scheduled task in JW."
  );
  ...
  registerBridgeTool(
    ...
    Type.Object({}),
    "List recurring scheduled tasks in JW."
  );
  ...
  registerBridgeTool(
    ...
    "Cancel a recurring scheduled task in JW."
  );
  ...
  registerBridgeTool(
    ...
    "Install, list, or manage JW skills."
  );
};
