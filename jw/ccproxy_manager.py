...
users with a Claude Pro/Max subscription to use JW without
...
def _is_editable_install() -> bool:
    """Return True if JW was installed in editable/development mode.
...
def maybe_start_ccproxy(config: JWConfig) -> subprocess.Popen | None:
