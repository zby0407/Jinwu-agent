"""Full-screen Textual interactive TUI for JW.
...
import jw.cli.channel as _ch_mod
from jw.cli.widgets.thread_selector import ThreadPickerWidget
...
async def _sync_tui_command_completion(
    ...
    if agent_swapped:
        from ..agent import _ensure_config
...
def run_textual_interactive(
    *,
    ...
    class JWTextualInteractiveApp(App[None]):  # type: ignore[type-arg]
        ...
        async def handle_session_resume(
            ...
            if workspace_dir:
                ...
                try:
                    ...
                    # Another jw process owns the langgraph dev for a
                    ...
                    self.append_system(
                        ...
                        "session, but async subagents and JWMemory workers "
                        "may be unavailable.",
                        style="yellow",
                    )
                finally:
        ...
        async def _check_for_updates(self) -> None:
            """Check PyPI for a newer JW version and notify."""
            try:
            ...
            for _hitl_round in range(_MAX_HITL_ROUNDS):
                ...
                try:
                    ...
                    if (
                        ...
                        self._append_system(
                            "Run jw onboard to set up your API key.",
                            style="dim",
                        )
                    else:
                    ...
                    if ws:
                        ...
                        try:
                            ...
                            logging.getLogger(__name__).warning(
                                ...
                                "to in-process sync delegation and JWMemory "
