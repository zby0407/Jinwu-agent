# Module 40 — Active Regions and Flares
...
- Active-region magnetic complexity and bipolar-region emergence.
- Flare definition and electromagnetic manifestation.
- Magnetic reconnection as an energy-release framework.
- GOES soft-X-ray flare classification and its measurement meaning.
- Flare occurrence rate across the solar cycle.
- Distinction among flare class, peak soft-X-ray flux, duration, fluence, and
  total released energy.
- Relationship and distinction among flares, CMEs, active regions, and cycle
  indicators.

## Questions this module must answer

1. What does a GOES flare class measure?
2. Why is one strong flare not evidence that the whole cycle is strong?
