...
for a set of queries. Uses jw's multi-provider LLM layer with tool calling
...
def _init_config():
    """Initialize jw config and apply env vars (once per process)."""
...
def run_single_query(
    ...
    Creates a minimal LLM invocation that simulates jw's skill presentation:
