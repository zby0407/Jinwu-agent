...
class TestLoadingWidget:
    ...
    def test_construction(self):
        from jw.cli.widgets.loading_widget import LoadingWidget
        from jw.cli.widgets.timed_status_widget import TimedStatusWidget
    ...
    def test_spinner_frames_not_empty(self):
        from jw.cli.widgets.loading_widget import _SPINNER_FRAMES
...
class TestCompactingWidget(unittest.TestCase):
    ...
    def test_construction(self):
        from jw.cli.widgets.compacting_widget import CompactingWidget
...
class TestThinkingWidget(unittest.TestCase):
    ...
    def test_construction_visible(self):
        from jw.cli.widgets.thinking_widget import ThinkingWidget
...
class TestSummarizationStateMachine(unittest.TestCase):
    ...
    def test_summary_continuation_events_do_not_finalize(self):
        from jw.cli.tui_interactive import (
...
class TestStoppedResponseText(unittest.TestCase):
    ...
    def test_trims_before_appending_marker(self):
        from jw.stream.display import build_stopped_response_text
...
class TestToolCallWidget(unittest.TestCase):
    ...
    def test_construction(self):
        from jw.cli.widgets.tool_call_widget import ToolCallWidget
...
class TestSubAgentWidget(unittest.TestCase):
    ...
    def test_construction(self):
        from jw.cli.widgets.subagent_widget import SubAgentWidget
...
class TestTodoWidget(unittest.TestCase):
    ...
    def test_construction_empty(self):
        from jw.cli.widgets.todo_widget import TodoWidget
...
class TestSystemMessage(unittest.TestCase):
    ...
    def test_construction_default_style(self):
        from jw.cli.widgets.system_message import SystemMessage
...
class TestIsFinalResponse(unittest.TestCase):
    ...
    def test_empty_state_is_final(self):
        from jw.cli.tui_interactive import _is_final_response
        from jw.stream.state import StreamState
    ...
    def test_active_subagent_not_final(self):
        from jw.cli.tui_interactive import _is_final_response
        from jw.stream.state import StreamState, SubAgentState
...
class TestCompletionLogic(unittest.TestCase):
    ...
    The completion methods live on JWTextualInteractiveApp but require a
    ...
    def _make_app(self, comp_items=None, comp_index=-1):
        ...
        class _StubApp:
            ...
            def __init__(self):
                from jw.commands._completion_engine import CompletionCandidate
...
class TestModelPickerWidgetOllama(unittest.TestCase):
    ...
    def _make_widget(self, entries=None, *, current_model=None):
        ...
        from jw.cli.widgets.model_picker import (
            _CUSTOM_OLLAMA_ID,
            ModelPickerWidget,
        )
    ...
    def _sentinel_index(self, widget):
        from jw.cli.widgets.model_picker import _CUSTOM_OLLAMA_ID
    ...
    def test_selecting_regular_row_posts_picked(self):
        ...
        from jw.cli.widgets.model_picker import ModelPickerWidget
