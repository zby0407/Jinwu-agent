...
run_label="main_cycle_morphology.v20"
...
export JW_WORKSPACE_DIR="$repo/.morphology-workspace-v20-20260827"
export JW_WORKSPACE_BINDINGS_DIR="$repo/.morphology-bindings-v20-20260827"
