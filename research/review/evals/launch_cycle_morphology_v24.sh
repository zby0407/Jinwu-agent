...
run_label="main_cycle_morphology.v24"
...
export JW_WORKSPACE_DIR="$repo/.morphology-workspace-v24-20260827"
export JW_WORKSPACE_BINDINGS_DIR="$repo/.morphology-bindings-v24-20260827"
...
case "${1:-}" in
  backend)
    ...
    ;;
  frontend)
    export JW_LANGGRAPH_DEV_PORT=6180
    export PORT=4722
