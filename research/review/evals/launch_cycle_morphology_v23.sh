...
run_label="main_cycle_morphology.v23"
...
export JW_WORKSPACE_DIR="$repo/.morphology-workspace-v23-20260827"
export JW_WORKSPACE_BINDINGS_DIR="$repo/.morphology-bindings-v23-20260827"
...
case "${1:-}" in
  backend)
    ...
    ;;
  frontend)
    export JW_LANGGRAPH_DEV_PORT=6179
    export PORT=4721
