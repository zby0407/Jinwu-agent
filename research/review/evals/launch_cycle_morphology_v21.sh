...
run_label="main_cycle_morphology.v21"
...
export JW_WORKSPACE_DIR="$repo/.morphology-workspace-v21-20260827"
export JW_WORKSPACE_BINDINGS_DIR="$repo/.morphology-bindings-v21-20260827"
...
case "${1:-}" in
  backend)
    ...
    ;;
  frontend)
    export JW_LANGGRAPH_DEV_PORT=6177
    export PORT=4719
