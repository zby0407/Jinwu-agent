#!/usr/bin/env python3
"""P1 一次性初始导入：静态知识雏形 + 历史归档 -> knowledge.db。
...
KNOWLEDGE_DIR = ROOT / "research" / "planner" / "knowledge"
LLM_WIKI_DIR = (
    ROOT
    / "jw"
    / "subagents"
...
LEGACY_RUNS = ROOT / "workspace" / "archive" / "legacy_contract_runs"
EXPERIMENT_RUNS = LEGACY_RUNS / "experiment"
HYPOTHESIS_RUNS = LEGACY_RUNS / "hypothesis"
